...
function actualizarCarritoUI(){
    fetch('http://localhost/Actividad%204/Carrito%20de%20compras/api/carrito/api-carrito.php?action=mostrar')
    .then(response =>{
...
const addItemToCarrito = id =>{
    fetch('http://localhost/Actividad%204/Carrito%20de%20compras/api/carrito/api-carrito.php?action=add&id=' + id)
    .then(response =>{
...
const removeItemFromCarrito = id =>{
    fetch('http://localhost/Actividad%204/Carrito%20de%20compras/api/carrito/api-carrito.php?action=remove&id=' + id)
    .then(res =>{
        return res.json();
    })
    .then(data =>{
